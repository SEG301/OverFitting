...
Quy trình biến dữ liệu "thô" thành dữ liệu "sạch" qua 4 giai đoạn tuần tự:

### Giai đoạn 1: Khử trùng lặp (Deduplication)
...
### Giai đoạn 3: Liên kết dữ liệu (Review Mapping)
